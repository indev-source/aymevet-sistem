<div class="modal fade bd-example-modal-lg-ventas" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    @foreach($bussines as $bussine)
                        <form action="{{asset('reportes/ventas/sucursal')}}" method="get">
