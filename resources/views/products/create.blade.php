			...
			<form action="{{asset('dashboard/v/admin/productos')}}" method="post">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<input type="text"  class="form-control {{ $errors->has('codigo') ? ' is-invalid' : '' }}" name="codigo" placeholder="Ingresa el codigo de barras">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<input type="number" id="costo" step="any" min="1" required class="form-control {{ $errors->has('costo') ? ' is-invalid' : '' }}" name="costo" placeholder="Ingresa el costo del producto">
						@if ($errors->has('costo'))
							<span class="invalid-feedback" role="alert">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" required id="p1" class="form-control" name="porcentaje1">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="">Porcentaje 2</label>
							<input type="text" id="p2" required class="form-control" name="porcentaje2">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="">Porcentaje 3</label>
							<input type="text" id="p3" required class="form-control" name="porcentaje3">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text"  id="pre1" required class="form-control" name="precio1">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="">Precio 2</label>
							<input type="text"  id="pre2" required class="form-control" name="precio2">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="">Precio 3</label>
							<input type="text"  id="pre3" required class="form-control" name="precio3">
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="number" step="any" value="0"  required class="form-control {{ $errors->has('iva') ? ' is-invalid' : '' }}" name="iva" placeholder="Ingresa el  IVA del producto.">
						@if ($errors->has('iva'))
							<span class="invalid-feedback" role="alert">
					...
					<div class="col-md-6">
						...
						<input type="text" value="h-87" class="form-control {{ $errors->has('clave_unidad') ? ' is-invalid' : '' }}" name="clave_unidad" placeholder="Ingresa la clave de unidad del producto.">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="lote" placeholder="Ingresa el lote del producto">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="">IEPS</label>
							<input type="text" class="form-control" name="ieps" placeholder="Ingresa el IEPS del producto">
						</div>
					</div>
				</div>
				<div class="row">
